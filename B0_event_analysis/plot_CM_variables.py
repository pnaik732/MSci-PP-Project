...
def main(program,type,event,phase,event_n):
	...
	leg11 = ROOT.TLegend(0.6, 0.74, 0.89, 0.89); leg11.AddEntry(h11_1,"\ \\bar{B}^0(C_T > 0)", "lf"); leg11.AddEntry(h11_2,"\ \\bar{B}^0(C_T < 0)", "lf"); legset(leg11)
	...
	leg22 = ROOT.TLegend(0.6, 0.74, 0.89, 0.89); leg22.AddEntry(h22_1,"\ \\bar{B}^0(C_T > 0)", "lf"); leg22.AddEntry(h22_2,"\ \\bar{B}^0(C_T < 0)", "lf"); legset(leg22)
	...
	leg33 = ROOT.TLegend(0.6, 0.74, 0.89, 0.89); leg33.AddEntry(h33_1,"\ \\bar{B}^0(C_T > 0)", "lf"); leg33.AddEntry(h33_2,"\ \\bar{B}^0(C_T < 0)", "lf"); legset(leg33)
	...
	leg44 = ROOT.TLegend(0.6, 0.74, 0.89, 0.89); leg44.AddEntry(h44_1,"\ \\bar{B}^0(C_T > 0)", "lf"); leg44.AddEntry(h44_2,"\ \\bar{B}^0(C_T < 0)", "lf"); legset(leg44)
	...
	leg55 = ROOT.TLegend(0.6, 0.74, 0.89, 0.89); leg55.AddEntry(h55_1,"\ \\bar{B}^0(C_T > 0)", "lf"); leg55.AddEntry(h55_2,"\ \\bar{B}^0(C_T < 0)", "lf"); legset(leg55)

...
df=pd.read_table('B0toDDbar0K+pi-.txt',sep="\s+")
...
c0.SaveAs("results/B0_invariant_mass_fit_10000.png")
...
c1.SaveAs("results/B0_invmass_D0Dbar0_fit_10000.png")
...
c2.SaveAs("results/B0_invmass_KpPim_fit_10000.png")

with open('results/data.txt',mode='a') as f:
...
c3.SaveAs("results/B0_helangle_D0Dbar0_10000.png")
...
c4.SaveAs("results/B0_helangle_KpPim_10000.png")
...
c5.SaveAs("results/B0_planeangle_10000.png")
